...
_STATIC_SP500_FALLBACK: tuple[str, ...] = (
    ...
    "CZR", "D", "DAL", "DASH", "DAY", "DD", "DE", "DECK", "DELL", "DG",
    ...
    "OTIS", "OXY", "PANW", "PAYC", "PAYX", "PCAR", "PCG", "PEG", "PEP",
    ...
    "TFC", "TGT", "TJX", "TMO", "TMUS", "TPL", "TPR", "TRGP", "TRMB", "TROW",
...
_STATIC_NASDAQ100_FALLBACK: tuple[str, ...] = (
    "ADBE", "ADI", "ADP", "ADSK", "AEP", "AMAT", "AMD", "AMGN", "AMZN",
    "ANSS", "APP", "ARM", "ASML", "AVGO", "AXON", "AZN", "BIIB", "BKNG",
    ...
    "KHC", "KLAC", "LIN", "LRCX", "LULU", "MAR", "MCHP", "MDLZ", "MELI",
    "META", "MNST", "MRVL", "MSFT", "MSTR", "MU", "NFLX", "NVDA", "NXPI",
    "ODFL", "ON", "ORLY", "PANW", "PAYX", "PCAR", "PDD", "PEP", "PLTR",
    "PYPL", "QCOM", "REGN", "ROP", "ROST", "SBUX", "SHOP", "SNPS", "TEAM",
    "TMUS", "TRI", "TTD", "TTWO", "TXN", "VRSK", "VRTX", "WBD", "WDAY",
    "XEL", "ZS",
)
            ...
            for table in tables:
                for column in ("Ticker", "Symbol"):
                    if column in table.columns:
                        symbols = [sanitize_ticker(str(s)) for s in table[column].tolist()]
                        break
                if symbols:
                    break
            if not symbols:
...
def register_universe_startup(app: Any) -> None:
    ...
    async def _universe_startup() -> None:  # pragma: no cover - exercised via TestClient
