...
class DonchianBreakout(BaseStrategy):
    ...
    def _calculate_indicators(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # quant/indicators.py. The warm-up window stays NaN rather than being
        # back-filled; `generate_signals` refuses to trade those bars instead
        # of pricing an ATR-multiple stop off a partial average.
