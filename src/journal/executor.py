...
class TradeJournal:
    ...
    def log_signal(self, ticker: str, entry_date: datetime, entry_price: float,
                   thesis: str, signal_strength: float, stop_loss: float,
                   target_1: float, target_2: float) -> int:
        """
    ...
    def log_entry(self, trade_id: int, actual_entry_price: float,
    ...
    def log_exit(self, trade_id: int, exit_date: datetime, exit_price: float,
        ...
        holding_days = (exit_date - trade['actual_entry_date']).days if pd.notna(trade['actual_entry_date']) else None
    ...
    def analyze_all_trades(self) -> Dict:
        ...
        return {
            ...
            'avg_holding_days': exited['holding_days'].mean() if exited['holding_days'].notna().any() else None,
        }
