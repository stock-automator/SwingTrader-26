...
class SignalQualityClassifier:
    ...
    def filter_signals(
        self, signals_df: pd.DataFrame, min_probability: float = 0.55
    ) -> pd.DataFrame:
        """
    ...
    def export_feature_importance(
        self, output_file: str = "results/feature_importance.json"
    ):
